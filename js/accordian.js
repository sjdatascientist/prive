const accordionData = {
    ...
    set3: [
        { header: "How do I book the car which I want ?", content: "We don’t have any sort of setup fees and our booking fee is Rs 10000/- (Ten thousand only) which is adjusted in the the final payment of the membership fee of 10% of the on road cost of the car. This booking helps you in getting priority in your city for your membership and you also have a chance of further discount of Rs 10000/- as early bird member. Please mention the city and the car you wish to co-own." },
        { header: "When do I make the balance payments ?", content: "Whenever we have to make payment to the car dealer, after approval of your membership, we will ask you for balance of membership payment after adjusting the 10000/- plus early bird discount of 10000/- if applicable. The AMC payment can be made after the car is delivered and just before you make your first slot booking. If for any reason, you need to cancel the membership booking" },
    ],
    set4: [
        ...
        { header: "How many days can I use the car in a year ?", content: "How many days can I use the car in a year ?" },
...
function loadAccordion(set) {
    ...
    accordion.innerHTML = "";
    accordionData[set].forEach(item => {
